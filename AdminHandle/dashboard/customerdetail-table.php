...
<body>
    <?php
        ...
        if (isset($_POST['update'])){
            $name = $_POST['cusfullname'];
            $address = $_POST['cusaddress'];
            $tel = $_POST['custel'];

            $sql = "UPDATE customers
                    SET CustomerFullName = '$name', CustomerAddress='$address', CustomerTel='$tel'
        ...
        $sql = "call GetCustomerDetailById($CustomerId);";
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="Customer-table.php" aria-expanded="false"><i class="fa fa-table"
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title text-uppercase font-medium font-14">Edit Customer</h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                                ...
                                <form class="form-horizontal form-material" action="" method="post">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input disabled type="text" name="cusid" value ="<?php  echo $cusRow["CustomerId"]?>"
                                                class="form-control p-0 border-0"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">FullName</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="cusfullname" value ="<?php  echo $cusRow["CustomerFullName"]?>"
                                                class="form-control p-0 border-0"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Username</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input disabled name="cususername" type="text" value ="<?php  echo $cusRow["CustomerUsername"]?>" class="form-control p-0 border-0">
                                        </div>
                                    </div>     
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Address</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="cusaddress" type="text" value ="<?php  echo $cusRow["CustomerAddress"]?>" class="form-control p-0 border-0">
                                        </div>
                                    </div> 
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Tel</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="custel" type="text" value ="<?php  echo $cusRow["CustomerTel"]?>" class="form-control p-0 border-0">
                                        </div>
                                    </div>                                
                                    <div class="form-group mb-4">
