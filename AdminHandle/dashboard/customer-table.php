...
<body>
    ...
    <?php
        ...
        $sql = "call GetCustomerByKeyWord('$keyword');";
        $result = $connect->query($sql); 
        $customers = $result->fetch_all(MYSQLI_BOTH);
        $result->close();
	    //Đóng database
	    $connect->close();
    ?>
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title text-uppercase font-medium font-14">Customer page</h4>
                    </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            ...
                            <a href="customercreation-table.php"
                                class="btn btn-danger  d-none d-md-block pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">New Customer</a>
                        </div>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            {
                                                echo "<tr>";
                                                    echo "<td>".$cus["CustomerId"]."</td>";
                                                    echo "<td>".$cus["CustomerFullName"]."</td>";
                                                    echo "<td>".$cus["CustomerUsername"]."</td>";
                                                    echo "<td>".$cus["CustomerAddress"]."</td>";
                                                    echo "<td>".$cus["CustomerTel"]."</td>"; ?>
                                                    <td><a href="customerdetail-table.php?CustomerId=<?php echo $cus["CustomerId"] ?>">Edit</a></td> <?php
                                                echo "</tr>";
                                            }
                                        ?>                                        
                                    </tbody>
