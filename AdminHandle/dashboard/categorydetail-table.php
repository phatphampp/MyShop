...
<body>
    <?php
        ...
        $sql = "call GetCategoryDetailById($CategoryId);";
        $result = $connect->query($sql);
        $catRow = mysqli_fetch_array($result);
        $result->close();
                                ...
                                <form class="form-horizontal form-material" action="" method="post">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input disabled type="text" name="catid" value ="<?php  echo $catRow["CategoryId"]?>"
                                                class="form-control p-0 border-0"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Name</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="catname" value ="<?php  echo $catRow["CategoryName"]?>"
                                                class="form-control p-0 border-0"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Description</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="catdescription" type="text" value ="<?php  echo $catRow["CategoryDescription"]?>" class="form-control p-0 border-0">
                                        </div>
                                    </div>
