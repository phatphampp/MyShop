...
<body>
    <?php
		...
		if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $tmp = "EmployeeFullName = '$EmployeeFullName', EmployeeAddress ='$EmployeeAddress', EmployeeTel='$EmployeeTel'";
			if(isset($_POST["fullname"])) { $EmployeeFullName = $_POST['fullname']; }
			if(isset($_POST["address"])) { $EmployeeAddress = $_POST['address']; }
			if(isset($_POST["telephone"])) { $EmployeeTel = $_POST['telephone']; }
			if(isset($_POST["password"])) { 
                $EmployeePassword = $_POST['password']; 
                $EmployeePassword = md5($EmployeePassword);
                $tmp = $tmp.", EmployeePassword='$EmployeePassword'";
            }
            ...
            $sql = "UPDATE employees
                    SET $tmp
                    where EmployeeUsername = '$curr_user'";
                                ...
                                <form class="form-horizontal form-material" action="" method="post">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" placeholder="Minibig" name="fullname" value ="<?php  echo $row["EmployeeFullName"]?>"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="tel" value ="<?php  echo $row["EmployeeTel"]?>" placeholder="123 456 7890"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="address" value ="<?php  echo $row["EmployeeAddress"]?>" placeholder="HCM"
                                                    class="form-control p-0 border-0">
                                        </div>
                                    </div>
