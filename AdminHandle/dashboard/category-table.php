...
<body>
    ...
    <?php
        ...
        $sql = "call GetCategoryByKeyWord('$keyword');";
        $result = $connect->query($sql); 
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title text-uppercase font-medium font-14">Category page</h4>
                    </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            ...
                            <a href="categorycreation-table.php"
                                class="btn btn-danger  d-none d-md-block pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">New Category</a>
                        </div>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
                                        ...
                                        <?php 
                                            foreach($categories as $cat)
                                            {
                                                echo "<tr>";
                                                    ...
                                                    <td><a href="categorydetail-table.php?CategoryId=<?php echo $cat["CategoryId"] ?>">Edit</a></td> <?php
                                                echo "</tr>";
                                            }
                                        ?>                                        
                                    </tbody>
