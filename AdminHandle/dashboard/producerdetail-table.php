    ...
    <?php
        ...
        if (isset($_POST['update'])){
            ...
            $sql = "UPDATE producers
                    SET ProducerName = '$name',  ProducerDescription='$description'
        ...
        $sql = "call GetProducerDetailById($ProducerId);";
        $result = $connect->query($sql);
        $prcRow = mysqli_fetch_array($result);
        $result->close();
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title text-uppercase font-medium font-14">Edit producer</h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                            ...
                            <div class="user-bg">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <img src="../../img/Producers/<?php  echo $prcRow["ProducerImage"]?>"
                                ...
                                <form class="form-horizontal form-material" action="" method="post">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input disabled type="text" name="prcid" value ="<?php  echo $prcRow["ProducerId"]?>"
                                                class="form-control p-0 border-0"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Name</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="prcname" value ="<?php  echo $prcRow["ProducerName"]?>"
                                                class="form-control p-0 border-0"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Description</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="prcdescription" type="text" value ="<?php  echo $prcRow["ProducerDescription"]?>" class="form-control p-0 border-0">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
