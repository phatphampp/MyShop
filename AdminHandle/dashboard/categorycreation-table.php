            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title text-uppercase font-medium font-14">Create category</h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                            ...
                            <div class="card-body">
                                <form name="productForm" class="form-horizontal form-material" action="" method="post">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="catdescription" type="text" placeholder="Category Desciption" class="form-control p-0 border-0">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
